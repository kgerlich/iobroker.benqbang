...
gulp.task('rename', function ()  {
    ...
    if (!newname) {
        console.log('Please write the new benqbang name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/benqbang.png')) {
        fs.renameSync(__dirname + '/admin/benqbang.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/benqbang.html')) {
        fs.renameSync(__dirname + '/widgets/benqbang.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/benqbang/js/benqbang.js')) {
        fs.renameSync(__dirname + '/widgets/benqbang/js/benqbang.js', __dirname + '/widgets/benqbang/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/benqbang')) {
        fs.renameSync(__dirname + '/widgets/benqbang',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /benqbang/g,
        ...
        {
            match: /benqbang/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'benqbang'
        },
        {
